...
public class job_queue {
    static HashMap<Integer,Integer> workerlist = new HashMap<>();
    static HashMap<Integer,Long> starttime = new HashMap<>();
    ...
    static void version(long num_of_workers, long num_of_jobs, long[] job_durations){
        ...
        for (int i = 0; i < num_of_jobs; i++){
            ...
            workerlist.put(i,thread.id);
            starttime.put(i,thread.nextfreetime);
